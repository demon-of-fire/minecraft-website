...
const RECIPES = [
    ...
    { id: "crossbow", name: "Crossbow", type: "crafting", result: "crossbow", resultCount: 1, ingredients: ["iron_ingot", "stick", "string", "tripwire_hook"], category: "weapons", added: "1.14", grid: ["string","iron_ingot","string","stick","string","stick","stick","tripwire_hook","stick"] },
    ...
    { id: "lapis_block", name: "Block of Lapis Lazuli", type: "crafting", result: "lapis_block", resultCount: 1, ingredients: ["lapis_lazuli"], category: "building", added: "alpha-1.0.0", grid: ["lapis_lazuli","lapis_lazuli","lapis_lazuli","lapis_lazuli","lapis_lazuli","lapis_lazuli","lapis_lazuli","lapis_lazuli","lapis_lazuli"] },
    ...
    { id: "rabbit_stew", name: "Rabbit Stew", type: "crafting", result: "rabbit_stew", resultCount: 1, ingredients: ["cooked_rabbit", "bowl", "carrot", "potato", "red_mushroom"], category: "food", added: "1.8", grid: [null,null,null,"red_mushroom","cooked_rabbit",null,"carrot","potato","bowl"] },
    { id: "suspicious_stew", name: "Suspicious Stew", type: "crafting", result: "suspicious_stew", resultCount: 1, ingredients: ["red_mushroom", "brown_mushroom", "bowl", "tulip"], category: "food", added: "1.14", grid: [null,"red_mushroom",null,"brown_mushroom",null,null,null,"bowl",null], note: "Effect depends on flower used" },
    ...
    { id: "fermented_spider_eye", name: "Fermented Spider Eye", type: "crafting", result: "fermented_spider_eye", resultCount: 1, ingredients: ["spider_eye", "sugar", "brown_mushroom"], category: "materials", added: "1.0.0", grid: [null,null,null,"sugar","spider_eye",null,null,"brown_mushroom",null] },
    ...
    { id: "soul_torch", name: "Soul Torch", type: "crafting", result: "soul_torch", resultCount: 4, ingredients: ["coal", "stick", "soul_sand"], category: "decoration", added: "1.16", grid: [null,null,null,null,"coal",null,null,"stick","soul_sand"] },
    ...
    { id: "name_tag", name: "Name Tag", type: "loot", result: "name_tag", resultCount: 1, ingredients: [], category: "misc", added: "1.0.0", note: "Found in Dungeon and Mineshaft chests, or from Librarian villager trades" },
    ...
    { id: "saddle", name: "Saddle", type: "loot", result: "saddle", resultCount: 1, ingredients: [], category: "misc", added: "alpha-1.0.0", note: "Found in Dungeon chests, Nether Fortress chests, and other structures, or from Leatherworker villager trades" },
    ...
    { id: "experience_bottle", name: "Bottle o' Enchanting", type: "loot", result: "experience_bottle", resultCount: 1, ingredients: [], category: "misc", added: "1.0.0", note: "Obtained from Cleric villager trades" },
    ...
    { id: "copper_bulb", name: "Copper Bulb", type: "crafting", result: "copper_bulb", resultCount: 4, ingredients: ["copper_ingot", "blaze_rod"], category: "decoration", added: "1.21", grid: ["copper_ingot","copper_ingot","copper_ingot","copper_ingot","blaze_rod","copper_ingot","copper_ingot","copper_ingot","copper_ingot"] },
