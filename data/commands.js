...
const COMMANDS = [
    ...
    // === CREATIVE ===
    {
        ...
        name: "/destroy",
        category: "creative",
        description: "Destroys blocks in a region.",
        syntax: "/destroy <from> <to>",
        aliases: [],
        permission: "commands.destroy",
        added: "1.0.0",
        examples: [
            "/destroy 0 0 0 10 10 10"
        ],
        params: [
    ...
    },
    {
        ...
        name: "/extract",
        category: "creative",
        description: "Extracts blocks from a region.",
        syntax: "/extract <from> <to> [mask]",
        aliases: [],
        permission: "commands.extract",
        added: "1.0.0",
        examples: [
            "/extract 0 0 0 10 10 10"
        ],
        params: [
            { name: "from", type: "position", required: true, description: "Start position" },
            { name: "to", type: "position", required: true, description: "End position" }
    ...
    },
    {
        ...
        name: "/set",
        category: "creative",
        description: "Sets blocks in a region.",
        syntax: "/set <from> <to> <block>",
        aliases: [],
        permission: "commands.set",
        added: "1.0.0",
        examples: [
            "/set 0 0 0 10 10 10 stone"
        ],
        params: [
            { name: "from", type: "position", required: true, description: "Start position" },
            { name: "to", type: "position", required: true, description: "End position" },
    ...
    },
    {
        ...
        name: "/copy",
        category: "creative",
        description: "Copies blocks to a clipboard.",
        syntax: "/copy <from> <to> [mask]",
        aliases: [],
        permission: "commands.copy",
        added: "1.0.0",
        examples: [
            "/copy 0 0 0 10 10 10"
        ],
    ...
    },
    {
        ...
        syntax: "/paste [offset]",
        aliases: [],
        permission: "commands.paste",
        added: "1.0.0",
        examples: [
            "/paste"
        ],
        params: [
            { name: "offset", type: "position", required: false, description: "Paste offset" }
        ]
    },
    {
        id: "stack",
        name: "/stack",
        category: "creative",
        description: "Stacks a selection.",
        syntax: "/stack <direction> [count] [mask]",
        aliases: [],
        permission: "commands.stack",
        added: "1.0.0",
        examples: [
            "/stack north 5"
        ],
        params: [
            { name: "direction", type: "string", required: true, description: "Direction to stack" },
            { name: "count", type: "integer", required: false, description: "Number of stacks" }
        ]
    },
